  ...
  _onMessage(message) {
    ...
    switch (message.type) {
      ...
      case "partition-received":
        ...
        break;
      case "resend-partition":
        this._onResendPartition(message.offset);
        break;
      case "progress":
...
class FileChunker {
  ...
  timeElapsed() {
    ...
    var timeDiff = this.endTime - this.beginTime;
    timeDiff /= 1000;
    var seconds = Math.round(timeDiff);
    console.log("transfer file elapsed " + seconds + " seconds");
  }
